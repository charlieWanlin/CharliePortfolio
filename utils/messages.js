...
export const MESSAGES = {
  ...
  coffre: {
    ...
    avecCle: `
      <span class="emphasis-gold">🏆NOUVEAU PERSONNAGE DÉBLOQUÉ ! 🏆</span><br><br>
      Tu as trouvé ton développeur en alternance ! Un projet, une tâche, un petit challenge ? Donne-moi l'occasion de te montrer ce que je peux apporter à l'équipe.
    `,
  ...
  // ===== PARCHEMIN (Fiche de personnage) =====
  // Objet spécial qui ouvre la fiche de personnage du développeur
  parchemin: {
    ...
    // Propose 2 boutons : consulter la fiche (B) ou continuer (A)
    message: `
      <span class="emphasis">Parchemin déplié !</span><br>
      Ma <span class="emphasis-gold">fiche de personnage</span> : classe,
      compétences et contrat de quête.
    `,
  },
