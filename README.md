...
<p align="center">
  <a href="https://charliewanlin.github.io/CharliePortfolio/"><strong>Jouer maintenant</strong></a> •
  <a href="https://github.com/charlieWanlin/CharliePortfolio.git"><strong>Code source</strong></a>
</p>
...
```bash
# Clone le projet
git clone https://github.com/charlieWanlin/CharliePortfolio.git
...
> Le projet utilise des modules ES6 : il doit être servi par un serveur HTTP,
> l'ouverture directe de `index.html` ne fonctionnera pas.
...
Diplômé du TP Développeur Web & Web Mobile, je poursuis vers le titre Concepteur Développeur d'Applications (Bac+3) avec ForEach Academy.
...
**Je recherche une alternance de deux ans à démarrer dès que possible, secteur Lille - Hauts-de-France / Paris - Île-de-France.**
